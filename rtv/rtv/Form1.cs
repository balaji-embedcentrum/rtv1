...
namespace VirtualModeTreeListView
{
    ...
    public partial class FormMain : Form
    {
        ...
        {
          // TODO:  AboutBox1 ab = new AboutBox1();
            // TODO: ab.ShowDialog(this);
        }
        ...
        private void ListView1DrawSubItem(object sender, DrawListViewSubItemEventArgs e)
        {
            ...
            if (e.ColumnIndex == 0)
            {
                ...
                {
                    // draw expanded icon
                    // TODO:     e.Graphics.DrawImage(imageList1.Images[1], m_Rect);
                }
                else if (0 == e.Item.StateImageIndex)
                {
                    // draw collapsed icon
                    // TODO:  e.Graphics.DrawImage(imageList1.Images[0], m_Rect);
                }
                else
                {
                    // draw normal icon (for unexpandable items)
                    // TODO:   e.Graphics.DrawImage(imageList1.Images[2], m_Rect);
                }
